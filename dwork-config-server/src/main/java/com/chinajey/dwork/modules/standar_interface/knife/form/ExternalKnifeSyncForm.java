package com.chinajey.dwork.modules.standar_interface.knife.form;
...
@Data
public class ExternalKnifeSyncForm extends CodeForm {
    ...
    @NotBlank(message = "刀具类别编码不能为空")
    private String knifeClassificationCode;

    //刀具类型  cutter：刀具，hilt：刀柄，attachment ：配件
    @NotBlank(message = "刀具类型不能为空")
    private String type;
